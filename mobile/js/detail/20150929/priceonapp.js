   ...
   var Priceonapp,
   		...
   		Priceonapp.prototype = {
	        ...
	        InitEvent: function() {
				...
				this.$dRoot.bind('priceOnapp',$.proxy(this.PriceonApp, this));
				this.$dRoot.delegate(this.$openAppWarp, 'click', $.proxy(this.openAppMethod, this));
	        },
	       PriceonApp:function(){
	        	var minPrice= arguments[1],maxprice = arguments[2];
	        	if(minPrice==maxprice){
	        		var oDiv='<div class="price-onapp"><a href="javascript:;" onClick="javascript:ga(\'send\', \'event\', \'Checkout-product\', \'TDCode\', \'priceonapp\')"><span class="appprice-tit">Price on the app:</span><span class="appprice">US $'+minPrice+'</span></a></div>';
	        	}else{
	        		var oDiv='<div class="price-onapp"><a href="javascript:;" onClick="javascript:ga(\'send\', \'event\', \'Checkout-product\', \'TDCode\', \'priceonapp\')"><span class="appprice-tit">Price on the app:</span><span class="appprice">US $'+minPrice+ '- '+maxprice+'</span></a></div>';
	        	}
	        	this.$openAppWarp.html(oDiv);
	        },
	        //ios和android配置一些基本信息
