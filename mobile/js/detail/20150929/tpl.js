		                ...
		                '<% for (var i = 0, len = data.length; i < len; i++) { %>',
			                '<% if (i==0) { %>',
		                        '<li class="active" data-leadtm="<%=data[i].leadingTime%>" data-deliverytm="<%=data[i].lowerDate%>&nbsp;and&nbsp;<%=data[i].upperDate%>">',
			                       ...
			                       '<% } %>',
			                       '<div class="method-type clearfix"><var class="method-deliveryway js-m-shipway" data-expresstype="<%=data[i].expressType%>"><%=data[i].expressType%></var><span class="method-deliverytm">delivery time: <span><%=data[i].deliveryTime%>days</span> to ship</span></li>',
			                    '</li>',
		                    '<% } else { %>',
