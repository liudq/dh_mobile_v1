...
(function(self, $){
    ...
    $.extend(Tip.prototype, {
        ...
        initEvent: function() {
            //对外暴露的自定义事件
            this.$loadingWarp.on('popupTip:loading', $.proxy(this.controlLoadingLayer, this));
            this.$dataErrorTipWarp.on('popupTip:dataErrorTip', $.proxy(this.setDataErrorTip, this));
            this.$autoLayerWarp.on('popupTip:autoTip', $.proxy(this.setAutoTip, this));
            //$dom事件
