...
!function (a) {
    ...
    function n(a, b) {
        ...
        a.each(function (d) {
            ...
            var f = a.eq(d);
            if (!b.skip_invisible || f.width() || f.height() || "none" === f.css("display"))if (b.vertical_only)if (l(f, b)); else if (j(f, b)) {
                if (++c > b.failure_limit)return !1
            } else g(); else if (l(f, b) || m(f, b)); else if (j(f, b) || k(f, b)) {
                if (++c > b.failure_limit)return !1
            } else g()
        })
    }
    ...
    var h, c = window, d = a(c), e = {
        ...
        placeholder_real_img: "http://css.dhresource.com/mobile/home/image/grey.png"
    }, f = /(?:iphone|ipod|ipad).*os/gi.test(navigator.appVersion), g = f && /(?:iphone|ipod|ipad).*os 5/gi.test(navigator.appVersion);
    h = function () {
        ...
        return a.isPlainObject(b) || (b = {}), a.each(e, function (f, g) {
            ...
            var e = this, f = j.eq(c), g = f.attr("src"), h = f.attr("data-" + b.data_attribute), k = b.url_rewriter_fn == i ? h : b.url_rewriter_fn.call(e, f, h), m = f.attr("data-" + b.data_srcset_attribute), n = f.is("img");
