...
;(function (root, factory) {
    ...
    * @returns number
    */
    var returnIOSVersion = function(){
        return parseInt(navigator.userAgent.match(/(iPhone\sOS)\s([\d_]+)/)[2].replace(/_/g, '.'));
    }
     /**获取Andoid的版本号
    * @returns string
    */
    var returnAndoidVersion = function(){
    ...
    var open = function(uri) {
        ...
        //小米不支持intent转化的地址，所以排除小米 2015-10-20
        ...
        iframe.onload = function() {
            ...
            //Android 其他版本跳转，防止弹出两次
            if (isIOS()) {
                window.location.href = uri;
            } 
            //Android 4.4.2解决唤起
            if(returnAndoidVersion()==='4.4.2'||returnAndoidVersion()==='5.0.1'){
                window.location.href = uri; 
            }
